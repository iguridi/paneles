...
from backend import calcular_area, calcular_areas_por_base, calcular_costos_por_panel, calcular_despiece_desde_agrupado, calcular_materia_prima_por_perfil, calcular_soldadura_por_panel, calcular_tiempos_por_panel, calcular_totales_perfiles, parse_panel_code
